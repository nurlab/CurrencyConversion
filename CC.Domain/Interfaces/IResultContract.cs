...
/// </remarks>
public interface IResultContract<T> where T : class, new()
{
    /// <summary>
    ...
    IResultContract<T> HandleException(Exception ex);
    ...
    IResultContract<T> ProcessErrorResponse(List<string> messages, string ErrorCode);
    ...
    IResultContract<T> ProcessSuccessResponse(T data);
    ...
    /// </exception>
    IResultContract<T> ProcessSuccessResponse(T data, List<string> messages);
}
